...
RSpec.describe Apexcharts::Utils::DateTime do
  context ".convert" do
    ...
    context 'input is a Time' do
      let(:input) { Time.parse("2019-06-18 20:20:20 +0700") }
    ...
    context 'input is a DateTime' do
      let(:input) { DateTime.parse("2019-06-18T20:20:20+0700") }
    ...
    context 'input is a Date' do
      let(:input) { Date.parse("2019-06-18") }

      it 'converts correctly' do
        expect(converted).to eq 1560790800000
      end
    end
  ...
  context ".convert_range" do
    ...
    context 'input is a Time' do
      let(:input) { Time.parse("2019-06-08 10:10:10 +0700")..Time.parse("2019-06-18 20:20:20 +0700") }
    ...
    context 'input is a DateTime' do
      let(:input) { DateTime.parse("2019-06-08T10:10:10+0700")..DateTime.parse("2019-06-18T20:20:20+0700") }
    ...
    context 'input is a Date' do
      let(:input) { Date.parse("2019-06-08")..Date.parse("2019-06-18") }

      it 'converts correctly' do
        expect(converted).to eq 1559926800000..1560790800000
      end
    end
